  ...
  return (
    <div>
      <div className="max-w-3xl mx-auto py-2">
        <h1 className="text-2xl font-bold text-dark mb-8">Seguridad</h1>
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-dark mb-3">Compromiso con la Seguridad</h2>
          <p className="text-sm text-gray-500 leading-relaxed">En FinTrack, la protección de tus datos es fundamental. Implementamos medidas avanzadas para garantizar la confidencialidad, integridad y disponibilidad de tu información financiera.</p>
        </section>
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-dark mb-3">Tecnologías y Protocolos</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-dark mb-3">Auditorías y Cumplimiento</h2>
          <ul className="list-disc pl-6 text-sm text-gray-500 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-dark mb-3">Educación y Prevención</h2>
          <ul className="list-disc pl-6 text-sm text-gray-500 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm text-gray-500">Si tienes preguntas sobre la seguridad de tu cuenta o detectaste una actividad sospechosa, contacta con nuestro equipo a través del correo <span className="font-semibold">soporte@fintrack.com</span>.</p>
        </section>
      </div>
      <Footer />
    </div>
